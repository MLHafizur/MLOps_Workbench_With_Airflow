...
def get_version():
    ...
    version_file2 = os.path.join(
        HERE, EXP_DIR, "mlops", "__init__.py")
...
setup(
    ...
    author_email="edu.hafizur@gmail.com",
    maintainer="Hafizur Rahman",
    maintainer_email="edu.hafizur@gmail.com",
    url="https://github.com/sertansenturk/mlops",
    description="Complete MLOps Project",
    long_description=get_long_description(),
    long_description_content_type="text/markdown",
    download_url=(
        "https://github.com/sertansenturk/mlops.git"
        if "dev" in get_version()
        else "https://github.com/sertansenturk/mlops/"
